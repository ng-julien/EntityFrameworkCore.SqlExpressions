...
[Northwind]
GO
/****** Object:  Table [dbo].[Customers]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS ON
GO
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Suppliers]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
...
[
    ...
    GO
/****** Object:  View [dbo].[Customer and Suppliers by City]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
--ORDER BY City, CompanyName
    GO
/****** Object:  Table [dbo].[Categories]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
[
    ...
    ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Products]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  View [dbo].[Alphabetical list of products]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
WHERE (((Products.Discontinued) = 0)) GO
/****** Object:  View [dbo].[Current Product List]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Product_List.ProductName
    GO
/****** Object:  Table [dbo].[Orders]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  View [dbo].[Orders Qry]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
SELECT Orders.OrderID,
       ...
       Customers.Country
FROM Customers
         INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID GO
/****** Object:  View [dbo].[Products Above Average Price]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Products.UnitPrice DESC
    GO
/****** Object:  View [dbo].[Products by Category]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Categories.CategoryName, Products.ProductName
    GO
/****** Object:  View [dbo].[Quarterly Orders]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
WHERE Orders.OrderDate BETWEEN '19970101' And '19971231' GO
/****** Object:  Table [dbo].[Employees]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
[
    ...
    ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Shippers]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Order Details]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  View [dbo].[Invoices]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
FROM Shippers
     ...
     ON Shippers.ShipperID = Orders.ShipVia GO
/****** Object:  View [dbo].[Order Details Extended]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY "Order Details".OrderID
    GO
/****** Object:  View [dbo].[Order Subtotals]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
FROM "Order Details"
GROUP BY "Order Details".OrderID GO
/****** Object:  View [dbo].[Product Sales for 1997]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
GROUP BY Categories.CategoryName, Products.ProductName GO
/****** Object:  View [dbo].[Category Sales for 1997]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
GROUP BY "Product Sales for 1997".CategoryName GO
/****** Object:  View [dbo].[Sales by Category]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Products.ProductName
    GO
/****** Object:  View [dbo].[Sales Totals by Amount]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
WHERE ("Order Subtotals".Subtotal > 2500)
  AND (Orders.ShippedDate BETWEEN '19970101' And '19971231') GO
/****** Object:  View [dbo].[Summary of Sales by Quarter]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Orders.ShippedDate
    GO
/****** Object:  View [dbo].[Summary of Sales by Year]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
--ORDER BY Orders.ShippedDate
    GO
/****** Object:  Table [dbo].[CustomerCustomerDemo]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[CustomerDemographics]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[EmployeeTerritories]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Region]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
[
    ...
    ON [PRIMARY]
    GO
/****** Object:  Table [dbo].[Territories]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS
    ON
    GO
    SET QUOTED_IDENTIFIER
...
ALTER TABLE [dbo].[Products] CHECK CONSTRAINT [CK_UnitsOnOrder]
    GO
/****** Object:  StoredProcedure [dbo].[CustOrderHist]    Script Date: 04/01/2023 14:43:44 ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
GROUP BY ProductName
    GO
/****** Object:  StoredProcedure [dbo].[CustOrdersDetail]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
WHERE Od.ProductID = P.ProductID
  and Od.OrderID = @OrderID
    GO
/****** Object:  StoredProcedure [dbo].[CustOrdersOrders]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
ORDER BY OrderID GO
/****** Object:  StoredProcedure [dbo].[Employee Sales by Country]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
FROM Employees
     ...
     (Orders INNER JOIN "Order Subtotals" ON Orders.OrderID = "Order Subtotals".OrderID)
     ON Employees.EmployeeID = Orders.EmployeeID
WHERE Orders.ShippedDate Between @Beginning_Date And @Ending_Date GO
/****** Object:  StoredProcedure [dbo].[Sales by Year]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
WHERE Orders.ShippedDate Between @Beginning_Date
  And @Ending_Date
    GO
/****** Object:  StoredProcedure [dbo].[SalesByCategory]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
...
WHERE OD.OrderID = O.OrderID
  ...
  AND SUBSTRING (CONVERT (nvarchar(22)
    , O.OrderDate
    , 111)
    , 1
    , 4) = @OrdYear
...
ORDER BY ProductName
    GO
/****** Object:  StoredProcedure [dbo].[Ten Most Expensive Products]    Script Date: 04/01/2023 14:43:44 ******/
SET ANSI_NULLS
ON
    GO
    SET QUOTED_IDENTIFIER ON
